...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-custom">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="https://cs.colostate.edu:4444/~kpalusa/m2/">Home </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="https://cs.colostate.edu:4444/~kpalusa/m2/index/m2/about.php">About</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link"
                        href="https://cs.colostate.edu:4444/~kpalusa/m2/index/m2/colorGenerator.php">Color
                        Generator</a>
                </li>
            </ul>
        </div>
